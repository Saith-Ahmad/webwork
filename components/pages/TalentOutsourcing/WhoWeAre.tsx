    ...
    return (
        <div className='container mt-14'>
            ...
            <div className="grid gap-4 p-6 grid-cols-1 md:grid-cols-12">
                ...
                <div className="md:col-span-6 bg-[#F3C9B6] rounded-md flex flex-col justify-between items-center transform-3d">
                    <div className='self-start p-7'>
                ...
                <div className="md:col-span-4 bg-[#ADD0F3] rounded-md flex flex-col justify-between items-center transform-3d">
                    <div className=' p-7'>
                ...
                <div className="md:col-span-3 p-7 bg-[#F3C9B6] rounded-md flex flex-col justify-between items-center transform-3d">
                    <div className='self-start '>
                ...
                <div className="md:col-span-5 bg-[#F8E1BE] rounded-md flex flex-col justify-between items-center transform-3d">
                    <div className=' p-7'>
                        <div className='max-w-[400px] min-h-[200px] '>
                ...
                <div className="md:col-span-4 p-7 bg-[#ADD0F3] rounded-md flex flex-col-reverse justify-between items-center transform-3d">
                    <div className='self-start '>
                        <div className='max-w-[400px] mt-3 '>
