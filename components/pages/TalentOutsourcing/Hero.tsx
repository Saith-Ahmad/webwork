    ...
    return (
        <div className='pb-20 md:pb-0 relative min-h-[100vh] bg-[#78D0EA] flex items-center justify-between pt-10 md:pt-0'>
            <div className='container space-y-10 flex flex-col md:flex-row justify-between items-center'>
                ...
                {/* Left Side Content */}
                <div className='md:p-10 p-3 flex flex-col gap-2 relative'>
                    ...
                    <FadeInBottom once={false} duration={0.5}>
                        <Link href={'/get-started'}>
                            <Button className='self-start mt-4 bg-white text-black rounded-full hover:bg-black hover:text-white' size={'lg'}>
                                Hire Top Talent Now
                            </Button>
                        </Link>
                    </FadeInBottom>
                ...
                <div className='md:max-w-[40%] relative'>
                    <FadeInRight once={false} duration={1}>
                        <Image alt='Remote Talent Acquisition' src={'/assets/talentoutsourcehero.png'} width={800} height={600} />
                    </FadeInRight>
                </div>
