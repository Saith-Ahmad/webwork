    ...
    return (
        <div className='container'>
            ...
            <div className="grid gap-6 p-6 grid-cols-1 md:grid-cols-12">
                ...
                <div className="md:col-span-7 bg-[#D2CCFA] p-8 rounded-md flex flex-col justify-between items-center max-h-[470px]">
                ...
                <div className="md:col-span-5 bg-[#F3C9B6] p-8 rounded-md flex flex-col-reverse justify-center items-center gap-4 max-h-[470px]">
                ...
                <div className="md:col-span-4 bg-[#F8E1BE] p-8 rounded-md flex flex-col justify-between items-center gap-4">
                ...
                <div className="md:col-span-4 bg-[#ADD0F3] p-8 rounded-md flex flex-col-reverse justify-between items-center gap-4">
                    <div>
                ...
                <div className="md:col-span-4 bg-[#D2CCFA] p-8 rounded-md flex flex-col justify-between items-center gap-4">
                    <div>
                ...
                <div className="md:col-span-7 bg-[#F3C9B6] p-8 rounded-md flex flex-col justify-between items-center gap-4 max-h-[470px]">
                    <div className='self-start'>
                ...
                <div className="md:col-span-5 bg-[#ADD0F3] p-8 rounded-md flex flex-col-reverse justify-between items-center gap-4 max-h-[470px]">
                    <div>
