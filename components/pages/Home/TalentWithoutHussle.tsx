        ...
        <div className='container mt-12'>
            <div className='bg-white shadow-lg shadow-gray-200 min-h-[100vh] rounded-3xl p-5  flex flex-col justify-center items-center relative overflow-hidden'>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-3'>
                    <div className='bg-[#F6F4EC4D] hover:bg-[#f7f1d74d] min-h-[400px] w-full lg:max-w-[300px]  p-5 rounded-lg flex flex-col justify-around transform-3d'>
                    ...
                    <div className='bg-[#CDF3FF4D] hover:bg-[#b7eeff4d] min-h-[400px] w-full lg:max-w-[300px]  p-5 rounded-lg flex flex-col justify-around transform-3d'>
                    ...
                    <div className='bg-[#ECF9F84D] hover:bg-[#ccf9f54d] min-h-[400px] w-full lg:max-w-[300px]  p-5 rounded-lg flex flex-col justify-around transform-3d'>
                    ...
                    <div className='bg-[#ECF9F84D] hover:bg-[#cbfbf74d] min-h-[400px] w-full lg:max-w-[300px]  p-5 rounded-lg flex flex-col justify-around transform-3d'>
