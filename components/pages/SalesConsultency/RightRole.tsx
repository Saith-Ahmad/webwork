        ...
        <div className='container mt-10'>
            <div className='bg-white max-lg:min-h-[60vh]  md:px-12 md:py-10 md:p-8 p-1  flex flex-col justify-center items-center relative overflow-hidden shadow-lg shadow-gray-200 md:rounded-[50px] rounded-[30px]'>
                ...
                <div className='flex gap-4 flex-col md:flex-row justify-center items-center overflow-hidden'>
                    ...
                    <div className='group col-span-1  bg-[#B1A79A33] md:min-h-[380px] min-h-[230px] w-full p-5 rounded-xl flex flex-col pb-8   relative overflow-hidden max-sm:mb-4'>
                        <div className="absolute w-[170px] h-[170px] bg-[#b1a89bd0] rounded-full blur-xl top-0 left-0 glow-anim z-0" />
                        <h2 className='font-roca text-6xl text-[#B1A79A]'>1</h2>
                    ...
                    <div className='group col-span-1 bg-[#CDF3FF66] md:min-h-[380px] min-h-[230px]  w-full p-5 rounded-xl flex flex-col pb-8 relative overflow-hidden'>
                        <div className="absolute w-[170px] h-[170px] bg-[#4bafcdad] rounded-full blur-xl top-0 left-0 glow-anim z-0" />
                        <h2 className='font-roca text-6xl text-[#5FADC6]'>2</h2>
                        <div className='relative z-10 mt-auto'>
                    ...
                    <div className='group col-span-1 bg-[#c5f8f44d] md:min-h-[380px] min-h-[230px] w-full p-5 rounded-xl flex flex-col pb-8 relative overflow-hidden'>
                        <div className="absolute w-[170px] h-[170px] bg-[#57aca4cf] rounded-full blur-xl top-0 left-0 glow-anim z-0" />
                        <h2 className='font-roca text-6xl text-[#58AAA4]'>3</h2>
                        <div className='relative z-10 mt-auto'>
                    ...
                    <div className='group col-span-1 bg-[#EFEEFDE5] md:min-h-[380px] min-h-[230px] w-full p-5 pb-8 rounded-xl flex flex-col relative overflow-hidden'>
                        <div className="absolute w-[170px] h-[170px] bg-[#c4bffbef] rounded-full blur-xl top-0 left-0 glow-anim z-0" />
                        <h2 className='font-roca text-6xl text-[#ABA5E8]'>4</h2>
                        <div className='relative z-10 mt-auto'>
