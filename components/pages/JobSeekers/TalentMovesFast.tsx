    ...
    return (
        <div className='container mt-10'>
            <div className='bg-white max-lg:min-h-[60vh]  md:px-12 md:py-10 md:p-8 p-1  flex flex-col justify-center items-center relative overflow-hidden shadow-lg shadow-gray-200 md:rounded-[50px] rounded-[30px]'>
                ...
                <div className='flex flex-row justify-around items-center w-full pb-10'>
                    <div className='flex flex-col justify-start items-start'>
                        <h4 className='text-2xl font-roca'>Apply</h4>
                        <p className='text-lg md:max-w-[300px] max-w-[150px]'>Apply in under 5 minutes</p>
                    </div>
                    <img src='/assets/new/tmf1.png' alt='talent acquisition' className='w-[160px] md:w-[400px]' />
                </div>
                ...
                <div className='flex flex-row-reverse justify-around items-center w-full'>
                    <div className='flex flex-col justify-start items-start'>
                        ...
                        <p className='text-lg md:max-w-[300px] max-w-[150px]'>Track every application</p>
                    </div>
                    <img src='/assets/new/tmf2.png' alt='talent acquisition' className='w-[160px] md:w-[400px]' />
                </div>
                ...
                <div className='flex flex-row md:justify-around justify-center items-center w-full'>
                    <div className='flex flex-col justify-start items-start'>
                        ...
                        <p className='text-lg md:max-w-[300px] max-w-[150px]'>Get interview ready resources</p>
                    </div>
                    <img src='/assets/new/tmf3.png' alt='talent acquisition' className='w-[160px] md:w-[400px]' />
                </div>
                <img src='/assets/new/connector.svg' alt='connector' className='w-[70%]' />
                ...
                <div className='flex flex-row-reverse justify-around items-center w-full'>
                    <div className='flex flex-col justify-start items-start'>
                        ...
                        <p className='text-lg md:max-w-[300px] max-w-[150px]'>Get feedback, not silence</p>
                    </div>
                    <img src='/assets/new/tmf4.png' alt='talent acquisition' className='w-[160px] md:w-[400px]' />
                </div>
                <img src='/assets/new/connector2.svg' alt='connector' className='w-[70%]' />
                ...
                <div className='flex flex-row justify-around items-center w-full'>
                    <div className='flex flex-col justify-start items-start'>
                        ...
                        <p className='text-lg md:max-w-[300px] max-w-[150px]'>Connect with companies who are ready to move</p>
                    </div>
                    <img src='/assets/new/tmf5.png' alt='talent acquisition' className='w-[160px] md:w-[400px]' />
                </div>
            </div>
        </div>
